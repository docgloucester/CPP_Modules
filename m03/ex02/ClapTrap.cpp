...
void	ClapTrap::attack(const std::string& target) 
{
	...
	{
		this->_energyPts--;
		std::cout << "ClapTrap " << this->_name << " attacks " << target <<", causing " << this->_attackDmg << " points of damage! EP left: " << this->_energyPts << std::endl;
	}
	else
...
{
	this->_hitPts -= amount;
	std::cout << "ClapTrap " << this->_name << " takes " << amount << " points of damage! HP left: " << this->_hitPts << std::endl;
}
